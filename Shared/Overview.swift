...
struct Overview: View {
    ...
    func returnStmnt(_ total: Float) -> String {
        return total > 0 ? "Congratulations! You are bringing in a take-home of $\(String(net_balance(total_incomes, total_expenses))) each month. You are properly managing your expenses to keep them under your income, keep up the great work!" : (total < 0 ? "You have a net loss of $\(String(net_balance(total_incomes, total_expenses))) per month, it is highly recommended to drop some expenses as soon as possible to avoid losing more money!" : "You have a zero net gain/loss. While you are not losing money, you are also not making any. It is recommended to drop a few expenses or find more income sources to rise to a positive net gain.")
    }
